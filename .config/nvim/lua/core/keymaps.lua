...
keymap.set("n", "<C-h>", "<C-w><C-h>", { desc = "[marcus] Move focus to the left window" })
keymap.set("n", "<C-l>", "<C-w><C-l>", { desc = "[marcus] Move focus to the right window" })
keymap.set("n", "<C-j>", "<C-w><C-j>", { desc = "[marcus] Move focus to the lower window" })
keymap.set("n", "<C-k>", "<C-w><C-k>", { desc = "[marcus] Move focus to the upper window" })

keymap.set("n", "<leader>bn", "<cmd>bn<CR>", { desc = "[marcus] Go to next buffer" })
keymap.set("n", "<leader>bp", "<cmd>bp<CR>", { desc = "[marcus] Go to previous buffer" })
keymap.set("n", "<leader>bd", "<cmd>bd<CR>", { desc = "[marcus] Close current buffer" })
